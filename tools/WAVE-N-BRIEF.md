# WAVE N BUILDER BRIEF (shared preamble — read this whole file first)
...
1. Your verdict file: `verdicts/wave-m/<your-piece>.md`. **This is your brief.** It names the
...
2. the SESSION 10 block of `STATE.md` (`awk '/^## SESSION 8/{exit} {print}' STATE.md`) plus `tools/STANDING-CONSTRAINTS.md` for the standing constraints and the
...
**Write your full report to `verdicts/wave-n/<your-piece>.md` BEFORE you return it as your final
